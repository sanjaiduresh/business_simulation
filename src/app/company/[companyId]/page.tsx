...
export default function CompanyDashboard() {
    const { state,  companyProducts, advancePeriod,  } = useSimulation();
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-gray-50 p-4 rounded-md">
            ...
            <p className="text-2xl font-bold">${company.cashBalance.toLocaleString()}</p>
          </div>
          <div className="bg-gray-50 p-4 rounded-md">
            <p className="text-gray-600">Total Assets</p>
            <p className="text-2xl font-bold">${company.totalAssets.toLocaleString()}</p>
          </div>
          <div className="bg-gray-50 p-4 rounded-md">
            <p className="text-gray-600">Total Liabilities</p>
            <p className="text-2xl font-bold">${company.totalLiabilities.toLocaleString()}</p>
          </div>
        </div>
