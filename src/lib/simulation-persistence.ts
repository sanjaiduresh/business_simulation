import { Simulation, SimulationState } from "@/components/simulation/types";
import { DatabaseService } from "./database";

export async function saveNewSimulation(state: Simulation, db: DatabaseService): Promise<void> {
    try{
